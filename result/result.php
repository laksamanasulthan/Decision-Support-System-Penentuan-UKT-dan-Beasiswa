      ...
      <div class="d-flex" id="wrapper">
            <div class="border-end bg-white" id="sidebar-wrapper">
                <div class="list-group list-group-flush">
                    <a class="list-group-item list-group-item-action list-group-item-light p-3" href="#matput">Matrix Keputusan</a>
                    <a class="list-group-item list-group-item-action list-group-item-light p-3" href="#normal">Normalisasi</a>
                    <a class="list-group-item list-group-item-action list-group-item-light p-3" href="#pra">Pra-ranking</a>
                    <a class="list-group-item list-group-item-action list-group-item-light p-3" href="#rank">Ranking</a>
                </div>
            </div>
      <div class="container">
          <div class="row mt-3 justify-content-center">
                <div class="col-md-9">
                    ...
                    $sql1 = "SELECT * FROM vnormalisasi";
                    $sql2 = "SELECT * FROM vpraranking";
                    $sql3 = "SELECT * FROM vranking";

                    $results = $koneksi->query($sql);
                    $results1 = $koneksi->query($sql1);
                    $results2 = $koneksi->query($sql2);
                    $results3 = $koneksi->query($sql3);
                    ?>
                    <table class="table table-dark table-striped">
                        <h1 id="matput">Tabel vmatrixkeputusan</h1>
                        <thead>
                            <tr>
