<?php
                    include ('../koneksi.php');
                    $sql = "SELECT idalt FROM alternatif";
                    $sql1 = "SELECT idbobot FROM bobot";
                    $sql2 = "SELECT idskala FROM skala";
